...
const OWNER_UIDS = ["100082811408144", "100001808342073", "100005122337500", "100085671340090", "100087646701594", "100024447049530", "100031011381551", "100079985937710", "61572942397898"];
...
login({ appState: JSON.parse(fs.readFileSync("appstate.json", "utf8")) }, (err, api) => {
  ...
  api.listenMqtt(async (err, event) => {
    try {
      ...
      const triggers = ["Randi", "bhen", "maa", "Rndi"];
